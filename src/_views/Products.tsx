...
const Products = () => {
  ...
  usePageMeta({
    ...
    description: "Каталог алюминиевых профилей AKFA INNOVATION: промышленные, конструкционные, фасадные, транспортные, солнечные профили и ЧПУ детали. Производство в Узбекистане, экспорт по всему миру.",
    canonical: "/products",
    jsonLd: {
